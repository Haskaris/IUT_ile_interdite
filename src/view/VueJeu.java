...
public class VueJeu {
    ...
    private final JPanel panelGrille, panelPrincipal, panelMenu, panelBtnAction, panelSouth, panelMain, panelLateral;
    ...
    public VueJeu(Observateur o, Grille gr) {
        ...
        panelLateral = new JPanel(new GridLayout(4, 1));                        // Panel mains autres joueurs
        panelPrincipal.add(panelLateral, BorderLayout.EAST);

        panelMain = new JPanel(new GridLayout(1, 5));                            // Panel main joueur courant
        ...
        labelJC = new JLabel(getNom());                                         // Initialisation du nom du joueur courant
